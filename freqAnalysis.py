...
6.97, 'N': 6.75, 'S': 6.33, 'H': 6.09, 'R':
2.78, 'U': 2.76, 'M': 2.41, 'W': 2.36, 'F':
1.93, 'B': 1.29, 'V': 0.98, 'K': 0.77, 'J':
0.07}
...
def getFrequencyOrder(message):
    ...
    for freq in freqToLetter:
        ...
        freqfreqToLetter[freq]= ''.join(freqToLetter[freq])
...
def englishFreqMatchScore(message):
    ...
    freqPrder= getFrequencyOrder(message)
